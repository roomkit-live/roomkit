...
submodule and re-exported from the package root. The logger keeps the original
``roomkit.orchestration.strategies.supervisor`` name so logging configured
against it continues to work unchanged.
"""
