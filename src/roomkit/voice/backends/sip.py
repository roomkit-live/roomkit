...
class SIPVoiceBackend(VoiceBackend):
    ...
    def __init__(
        ...
        *,
        ...
        self._auth_nonces: dict[str, float] = {}  # nonce → expiry (monotonic)
    ...
    def _validate_invite_auth(self, call: Any) -> bool:
        ...
        expected = _compute_digest(username, self._auth_realm, password, "INVITE", uri, nonce)
    ...
    def _send_auth_challenge(self, call: Any) -> None:
        ...
        self._auth_nonces[nonce] = time.monotonic() + _NONCE_TTL
    ...
    async def _do_register(self, *, expires: int) -> None:
        ...
        digest = _compute_digest(username, realm, password, "REGISTER", request_uri, nonce)
