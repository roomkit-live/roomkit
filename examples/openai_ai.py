"""OpenAI AI example — AI-powered assistant using OpenAI GPT.

Run with:
    OPENAI_API_KEY=sk-... uv run python examples/openai_ai.py
"""
...
async def main() -> None:
    ...
    ws.register_connection("user-conn", on_receive, room_id="demo-room")
